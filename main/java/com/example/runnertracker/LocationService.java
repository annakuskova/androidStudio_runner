...
public class LocationService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        Log.d("mdp", "Location Service создан");
    ...
    private void addNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "Отслеживание пробежки";
            String description = "Продолжать работу!";
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this,
                ...
                .setContentText("Продолжать работу!")
    ...
    public void onDestroy() {
        ...
        Log.d("mdp", "Определение местоположения невозможно");
    }
    ...
    protected void saveJourney() {
        ...
        Log.d("mdp", "Пробежка сохранена с id = " + journeyID);
    }
    ...
    protected void changeGPSRequestFrequency(int time, int dist) {
        ...
        try {
            ...
            Log.d("mdp", "Новое время = " + time + ", расстояние = " + dist);
        } catch(SecurityException e) {
            // don't have the permission to access GPS
            Log.d("mdp", "Нет доступа к GPS");
        }
