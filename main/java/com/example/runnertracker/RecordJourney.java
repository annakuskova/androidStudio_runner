...
//        gif.pause();
    ...
    public void onClickStop(View view) {
       ...
       // gif.pause();
        ...
        DialogFragment modal = FinishedTrackingDialogue.newInstance(String.format("%.2f", distance));
    ...
    public static class FinishedTrackingDialogue extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            builder.setMessage("Ваш результат сохранен."/* + getArguments().getString("distance") + " KM"*/)
    ...
    public static class NoPermissionDialogue extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
            builder.setMessage("GPS необходим для отслеживания вашей пробежки")
                    .setPositiveButton("Включить GPS", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
