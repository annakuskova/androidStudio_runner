...
public class DBHelper extends SQLiteOpenHelper {
    ...
    // вызывается, когда вызывается getWritableDatabase, а файл базы данных не существует
    @Override
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE journey (" +
                ...
                "name varchar(256) NOT NULL DEFAULT 'Пробежка'," +
    ...
    // вызывается, когда файл базы данных существует, но номер версии, хранящийся в базе данных, ниже, чем переданный в конструкторе
    @Override
