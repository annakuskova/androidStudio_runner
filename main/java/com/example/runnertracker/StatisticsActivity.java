...
public class StatisticsActivity extends AppCompatActivity {
    ...
    private void setUpDateDialogue() {
        dateText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(dateText.getText().toString().toLowerCase().equals("выбрать дату")) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                postBack.post(new Runnable() {
                   public void run() {
                       distanceToday.setText(String.format("%.2f км", distanceTodayKM_));
                       timeToday.setText(String.format("%02d:%02d:%02d", hours, minutes, seconds));
                       recordDistance.setText(String.format("%.2f км", recordDistanceKM_));
                       distanceAllTime.setText(String.format("%.2f км", totalDistanceKM_));
    ...
    private void loadBarChart(ArrayList<BarEntry> entries) {
        BarDataSet bardataset = new BarDataSet(entries, "Дни");
        ...
        barChart.setDescription("Расстояние (км)");  // set the description
